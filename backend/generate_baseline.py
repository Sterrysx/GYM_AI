...
SCHEDULE = {
    1: {
        ...
        "exercises": [
            ...
            {"exercise_id": "overhead_cable_tricep_ext", "sets": 4, "target_reps": 10,  "strategy": "linear",           "superset_group": "B",
             "linked_to": {"day": 5, "exercise_id": "overhead_cable_tricep_ext"}},
            {"exercise_id": "lateral_dumbbell_raises",   "sets": 4, "target_reps": 12,  "strategy": "linear",           "superset_group": "B",
             "linked_to": {"day": 5, "exercise_id": "lateral_dumbbell_raises"}},
            {"exercise_id": "tricep_pushdowns",          "sets": 4, "target_reps": 12,  "strategy": "linear",           "superset_group": "C",
             "linked_to": {"day": 5, "exercise_id": "tricep_rope_pulldowns"}},
            {"exercise_id": "lateral_cable_raises",      "sets": 4, "target_reps": 12,  "strategy": "linear",           "superset_group": "C",
    ...
    3: {
        ...
        "exercises": [
            ...
            {"exercise_id": "machine_calf_extensions", "sets": 4, "target_reps": 15,  "strategy": "linear", "superset_group": "C"},
    ...
    5: {
        "day_name": "Arms",
        "exercises": [
            {"exercise_id": "overhead_cable_tricep_ext", "sets": 4, "target_reps": 12,  "strategy": "linear", "superset_group": "A",
             "linked_to": {"day": 1, "exercise_id": "overhead_cable_tricep_ext"}},
            {"exercise_id": "cable_bicep_open_curls",    "sets": 4, "target_reps": 12,  "strategy": "linear", "superset_group": "A",
             "linked_to": {"day": 2, "exercise_id": "cable_bicep_open_curls"}},
            {"exercise_id": "tricep_rope_pulldowns",     "sets": 4, "target_reps": 15,  "strategy": "linear", "superset_group": "B",
             "linked_to": {"day": 1, "exercise_id": "tricep_pushdowns"}},
            {"exercise_id": "dumbbell_hammer_curls",     "sets": 4, "target_reps": 12,  "strategy": "linear", "superset_group": "B",
...
WEEK1_BASELINES = {
    ...
    (1, "overhead_cable_tricep_ext"): [65, 60, 55, 50],
    (1, "lateral_dumbbell_raises"):   [8, 7, 6, 6],
    (1, "tricep_pushdowns"):          [85, 80, 75, 70],
    (1, "lateral_cable_raises"):      [3.75, 3.75, 2.5, 2.5],
    ...
    (3, "machine_calf_extensions"):    [50, 45, 40, 35],
    ...
    # ── Day 5: Arms ──────────────────────────────────────────────────────────
    (5, "overhead_cable_tricep_ext"):  [65, 60, 55, 50],
    (5, "cable_bicep_open_curls"):     [20, 20, 17.5, 15],
    (5, "tricep_rope_pulldowns"):      [85, 75, 70, 65],
    (5, "dumbbell_hammer_curls"):      [18, 18, 16, 16],
